...
public class HeatingSystemExchangeRate {
    ...
    public HeatingSystemExchangeRate() {
        this(HeatingType.DISTRICT_HEAT, 0d, 0d, 0d, 0d, 0d, 0d, 0d, 0d, 0d);
    }

    public HeatingSystemExchangeRate(HeatingType oldType, Double lowTempBoilerRate, Double districtHeatRate, Double condensingBoilerRate, Double condBoilerSolarRate,
