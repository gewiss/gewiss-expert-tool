...
The GEWISS Expert Tool (GET) is a simulation tool developed by the [MMLab](https://www.haw-hamburg.de/department-informations-und-elektrotechnik/labore/multimediale-systeme.html) at the [HAW Hamburg](https://www.haw-hamburg.de) as part of the name giving [GEWISS](http://gewiss.haw-hamburg.de/) Project. Here the tool was developed as part of work package 7 by [Thomas Preisler](mailto:thomas.preisler@haw-hamburg.de) and [Nils Weiss](mailto:nils.weiss@haw-hamburg.de). [Arjun Jamil](mailto:arjun.jamil@haw-hamburg.de) provided additional support in the form of simulation logic, UI and UX design. The test data set was kindly provided by [Ivan Dochev](mailto:ivan.dochev@hcu-hamburg.de) from the [HCU Hamburg](https://www.hcu-hamburg.de/). Among other things the project aims at simulating the development of the building stock in the city of Hamburg (Germany) until 2050. GET intends to let expert users, like city planners, simulation different development scenarios for a given building stock under certain conditions. These user can define certain conditions for the building stock development and then simulate how these conditions might influence the building stock in the future. Thereby, the users can get an idea about what measuresments are needed to reach certain goals regarding the reduction of heat demand and CO<sub>2</sub> emission.
